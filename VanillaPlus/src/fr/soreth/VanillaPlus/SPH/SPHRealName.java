...
public class SPHRealName extends SPH{
	private static Pattern pattern = Pattern.compile("%" + sender + "_real_name%");
	private static SPHRealName instance = new SPHRealName();
	public String getPH(String key){
		return "%" + key + "_real_name%";
	}
