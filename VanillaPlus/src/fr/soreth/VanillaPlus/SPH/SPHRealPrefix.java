...
public class SPHRealPrefix extends SPH{
	private static Pattern pattern = Pattern.compile("%" + sender + "_real_prefix%");
	private static SPHRealPrefix instance = new SPHRealPrefix();
	@Override
	public String getPH(String key) {
		return "%"+key+"_real_prefix%";
	}
	...
	public String getReplacement(Localizer lang, VPSender sender) {
        return sender instanceof VPPlayer ? ((VPPlayer) sender).getPrefix() : EMPTY;
	}
}
