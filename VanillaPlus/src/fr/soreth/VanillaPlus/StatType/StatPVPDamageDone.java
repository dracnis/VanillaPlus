...
public class StatPVPDamageDone extends Stat implements Listener{
	public StatPVPDamageDone(Short id, ConfigurationSection section, MComponentManager manager) {
	...
	public void onStatUpdate(PVPDamageEvent event){
		if(event.getDamager() != null)
			increase(event.getDamager(), (int) (event.getDamage()*5));
	}
}
